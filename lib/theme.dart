...
ThemeData get lightTheme => ThemeData(
  ...
  inputDecorationTheme: InputDecorationTheme(
    ...
    border: OutlineInputBorder(
      ...
      borderSide: BorderSide(color: LightModeColors.lightOutline.withValues(alpha: 0.25)),
    ),
    ...
    focusedBorder: OutlineInputBorder(
      borderRadius: BorderRadius.circular(AppRadius.lg),
      borderSide: const BorderSide(color: LightModeColors.lightPrimary, width: 1.4),
    ),
  ...
  navigationBarTheme: NavigationBarThemeData(
    labelTextStyle: WidgetStatePropertyAll(_buildTextTheme(Brightness.light).labelMedium),
  ),
...
ThemeData get darkTheme => ThemeData(
  ...
  inputDecorationTheme: InputDecorationTheme(
    ...
    border: OutlineInputBorder(
      borderRadius: BorderRadius.circular(AppRadius.lg),
      borderSide: BorderSide(color: DarkModeColors.darkOutline.withValues(alpha: 0.35)),
    ),
    enabledBorder: OutlineInputBorder(
      borderRadius: BorderRadius.circular(AppRadius.lg),
    ...
    focusedBorder: OutlineInputBorder(
      borderRadius: BorderRadius.circular(AppRadius.lg),
      borderSide: const BorderSide(color: DarkModeColors.darkPrimary, width: 1.4),
    ),
    contentPadding: const EdgeInsets.symmetric(horizontal: AppSpacing.md, vertical: 14),
  ),
  filledButtonTheme: FilledButtonThemeData(
  ...
  navigationBarTheme: NavigationBarThemeData(
    labelTextStyle: WidgetStatePropertyAll(_buildTextTheme(Brightness.dark).labelMedium),
  ),
  cardTheme: CardThemeData(
    elevation: 0,
    shape: RoundedRectangleBorder(
